...
(
  ...
  'approved',
  'agendas',
  '{"agenda_items": [{"category": "Medication Review", "item": "Lyrica 150mg dosage reassessment"}, {"category": "Referral", "item": "Physiotherapy - aqua therapy"}, {"category": "New Symptom", "item": "Burning sensation in left hand"}, {"category": "Treatment Option", "item": "Nerve block reconsideration"}]}',
...
(
  ...
  'approved',
  'clinical_summary',
  '{"chief_complaint": "Worsening pain control and new symptom onset", "medication_review": {"current": [{"name": "Lyrica", "dose": "150mg", "frequency": "daily", "efficacy": "declining"}, {"name": "Panadol Osteo", "dose": "PRN", "frequency": "as needed", "efficacy": "partial"}], "concern": "Lyrica effectiveness decreasing"}, "pain_assessment": {"average": "6-7/10", "peak": "8+/10", "trend": "worsening"}, "sleep": {"average_hours": "4-5", "quality": "poor", "disruptions": "pain-related"}, "new_symptoms": [{"description": "Burning sensation in left hand", "onset": "10 days ago", "pattern": "intermittent"}], "patient_goals": "Better pain management, sleep improvement, investigate new hand symptoms"}',
